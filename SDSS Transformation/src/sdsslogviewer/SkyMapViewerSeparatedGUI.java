...
/**
 * Initial GUI of SkyMap Viewer.<p/>
 * Jan. 17th, 2011: Class created to construct a separated GUI for SkyMap Viewer.<p/>
 *                  Has the same menu and toolbar as LogViewerGUI, and has the
 *                  same file manager function.<p/>
 *                  But has the SkyMap viewer only.<p/>
 * @author James
 */
public class SkyMapViewerSeparatedGUI {
     ...
     */
    public SkyMapViewerSeparatedGUI() throws SQLException, ClassNotFoundException, DataIOException{
    ...
    private void initUI() throws SQLException, ClassNotFoundException{
        ...
        GUI = new JFrame("SDSS SkyMap Viewer Alpha 0.2");
        ...
        GUI.getContentPane().add(SkyMapPane, BorderLayout.CENTER);
...
System.out.println("This round is finished.");
	...
	public static void main(String[] args) throws SQLException, ClassNotFoundException, DataIOException {
        ...
        SkyMapViewerSeparatedGUI sdss = new SkyMapViewerSeparatedGUI();
    }
